    ...
    children: (
      <>
        ...
        <ul>
          ...
          <li>
            Implemented intelligent server-side pagination, optimizing response
          ...
          <li>
            Enhanced security with measures such as CORS and request limits per
            IP.
          </li>
          <li>
  ...
  },
  {
    ...
    children: (
      <>
        ...
        <ul>
          <li>
            Rebuilt a system using MongoDB to improve scalability and optimized
            over 200,000 documents.
          </li>
          <li>
            Resolved system load issues by reducing from 5 servers to 3 through
            the implementation of a load balancing system with Nginx.
          </li>
          <li>
