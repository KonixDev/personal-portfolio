...
const tiers = [
  {
    ...
    name: "Diagnóstico",
    price: "Desde $800",
    desc: "Análisis completo de tu sistema con reporte de cuellos de botella, priorización y plan de acción.",
    includes: [
      "Profiling de performance",
      "Análisis de queries y base de datos",
      "Revisión de infraestructura y costos",
      "Reporte con priorización",
    ],
    timeline: "3 — 5 días",
    wa: "Hola Martín, necesito un diagnóstico de performance de mi sistema.",
  },
  {
    key: "optimizacion",
    name: "Optimización Completa",
    price: "Desde $3.000",
    desc: "Diagnóstico + implementación de todas las mejoras. Medición de antes vs después en cada cambio.",
    includes: [
      ...
      "Re-test y verificación",
    ],
    timeline: "2 — 4 semanas",
    featured: true,
    wa: "Hola Martín, necesito optimizar mi sistema completo.",
  },
  {
    key: "continuo",
    name: "Mantenimiento Continuo",
    price: "Desde $1.000/mes",
    desc: "Monitoreo permanente, optimizaciones proactivas y soporte prioritario. Para sistemas críticos.",
    includes: [
      "Monitoreo 24/7 con alertas",
      "Optimizaciones mensuales proactivas",
      "Revisión de costos trimestral",
      "Soporte prioritario ante incidentes",
      "Reportes mensuales de métricas",
    ],
    timeline: "Mensual",
    wa: "Hola Martín, me interesa mantenimiento continuo de performance.",
  },
];

export function OptPricing() {
  ...
  return (
    <section ref={ref} className="section-padding grid place-items-center">
      ...
      >
        Desde un diagnóstico hasta optimización continua. El alcance lo definimos juntos.
      </motion.p>
      ...
      <div className="mt-16 grid w-full max-w-[1100px] grid-cols-1 gap-5 md:grid-cols-3">
        {tiers.map((tier, i) => {
          ...
          return (
            ...
            >
              {isFeat && (
                <span className="absolute -top-3 left-6 rounded-full bg-[#22C55E] px-3 py-1 text-[11px] font-semibold text-white">
                  Más elegido
                </span>
              )}
              <div>
              ...
              <ul className="flex flex-col gap-2.5">
                {tier.includes.map((line) => (
                  <li key={line} className="flex items-start gap-2.5 text-[13.5px]">
                    <span className={"mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full " + (isFeat ? "bg-[#22C55E]" : "bg-[var(--color-text-tertiary)]")} />
