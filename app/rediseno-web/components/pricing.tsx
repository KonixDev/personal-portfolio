...
const tiers = [
  {
    ...
    name: "Refresh Visual",
    price: "Desde $1.500",
    desc: "Mismo contenido, nuevo diseño. Ideal si tu sitio funciona pero se ve desactualizado.",
    includes: [
    ...
    wa: "Hola Martín, quiero un refresh visual de mi sitio.",
  },
  {
    key: "completo",
    name: "Rediseño Completo",
    price: "Desde $3.500",
    desc: "Nuevo diseño, nueva estructura, nuevo código. Auditoría previa, migración SEO, panel admin.",
    includes: [
      "Auditoría del sitio actual",
      "Rediseño de estructura y navegación",
      "Nuevo código desde cero",
      "SEO avanzado + redirecciones",
      "Panel de administración",
      "Analytics y conversión",
    ],
    timeline: "3 — 6 semanas",
    featured: true,
    wa: "Hola Martín, necesito un rediseño web completo.",
  },
  {
    key: "plataforma",
    name: "Migración de Plataforma",
    price: "A medida",
    desc: "Migración completa desde WordPress, Wix, Shopify u otra plataforma a un sistema moderno a medida.",
    includes: [
      "Análisis de plataforma actual",
      "Migración de datos y contenido",
      "Redirecciones 1:1 de URLs",
      "Nuevo sistema a medida",
      "Entrenamiento para tu equipo",
      "Soporte extendido",
    ],
    timeline: "Variable",
    wa: "Hola Martín, necesito migrar mi sitio a una plataforma nueva.",
  },
];
...
export function RedesignPricing() {
  ...
  return (
    <section ref={ref} className="section-padding grid place-items-center">
      ...
      >
        Desde un refresh visual hasta una migración completa de plataforma.
      </motion.p>
      ...
      <div className="mt-16 grid w-full max-w-[1100px] grid-cols-1 gap-5 md:grid-cols-3">
        {tiers.map((tier, i) => {
          ...
          return (
            ...
            >
              {isFeat && (
                <span className="absolute -top-3 left-6 rounded-full bg-[#F59E0B] px-3 py-1 text-[11px] font-semibold text-white">
                  Más elegido
                </span>
              )}
              <div>
              ...
              <ul className="flex flex-col gap-2.5">
                {tier.includes.map((line) => (
                  <li key={line} className="flex items-start gap-2.5 text-[13.5px]">
                    <span className={"mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full " + (isFeat ? "bg-[#F59E0B]" : "bg-[var(--color-text-tertiary)]")} />
