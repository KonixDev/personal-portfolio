...
const steps = [
  {
    n: "01",
    name: "Entendemos tu negocio",
    desc: "Llamada de 30 min gratis. Entendemos qué necesitás, quiénes son tus usuarios, y qué problema resuelve tu sistema.",
    meta: "Gratis · 30 min",
  },
  {
    n: "02",
    name: "Diseño y propuesta",
    desc: "Wireframes, mapa del sitio, y propuesta con alcance cerrado y precio fijo. En 48 horas.",
    meta: "48 horas",
  },
  {
    n: "03",
    name: "Desarrollo",
    desc: "Avances semanales visibles en una URL de prueba. Podés revisar, comentar y pedir ajustes en cada iteración.",
    meta: "2 — 10 semanas",
  },
  {
    n: "04",
    name: "Lanzamiento",
    desc: "Tu sistema queda funcionando en tu dominio, optimizado para buscadores, con documentación y todo configurado.",
    meta: "Online y tuyo",
  },
];
