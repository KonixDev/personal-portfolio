...
const tiers = [
  {
    key: "canal",
    name: "Canal / App Simple",
    price: "Desde $5.000",
    desc: "Un canal de TV en vivo o app de contenido simple. Reproductor, catálogo básico y publicación en Play Store.",
    includes: [
      "Reproductor HLS/DASH",
    ...
    wa: "Hola Martín, quiero una app de TV simple / canal en vivo.",
  },
  {
    key: "streaming",
    name: "Plataforma Streaming",
    price: "Desde $10.000",
    desc: "Tu propio servicio de streaming completo. Catálogo, suscripciones, perfiles, reproductor avanzado y app companion.",
    includes: [
      "App Android TV completa",
      "App companion mobile (iOS + Android)",
      "Suscripciones (Google Play Billing)",
      "Perfiles de usuario",
      "Reproductor con subtítulos y calidades",
      "Panel de administración de contenido",
      "Chromecast integrado",
    ],
    timeline: "10 — 14 semanas",
    featured: true,
    wa: "Hola Martín, quiero crear una plataforma de streaming.",
  },
  {
    key: "custom-tv",
    name: "Proyecto Custom",
    price: "A medida",
    desc: "Digital signage, apps de fitness, karaoke, juegos o cualquier experiencia para la pantalla grande.",
    includes: [
      "Diseño de experiencia TV a medida",
      "Integración con hardware específico",
      "App companion si aplica",
      "Backend y CMS",
      "Soporte extendido",
    ],
    timeline: "Variable",
    wa: "Hola Martín, tengo un proyecto custom para Android TV.",
  },
];
      ...
      <div className="mt-16 grid w-full max-w-[1100px] grid-cols-1 gap-5 md:grid-cols-3">
        {tiers.map((tier, i) => {
          ...
          return (
            ...
            >
              {isFeat && (
                <span className="absolute -top-3 left-6 rounded-full bg-[#8B5CF6] px-3 py-1 text-[11px] font-semibold text-white">
                  Más completo
                </span>
              )}
              <div>
              ...
              <ul className="flex flex-col gap-2.5">
                {tier.includes.map((line) => (
                  <li key={line} className="flex items-start gap-2.5 text-[13.5px]">
                    <span className={"mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full " + (isFeat ? "bg-[#8B5CF6]" : "bg-[var(--color-text-tertiary)]")} />
