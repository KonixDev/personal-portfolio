...
export function TvCta() {
  ...
  return (
    <section ref={ref} className="grid place-items-center px-5 pt-14 pb-12 md:px-12 md:pt-24 md:pb-16">
      ...
      >
        Una llamada de 30 minutos. Te contamos cómo sería tu app de TV y en cuánto tiempo la tenés en la pantalla grande.
      </motion.p>
